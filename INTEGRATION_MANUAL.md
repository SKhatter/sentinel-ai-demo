# Sentinel.AI — Manual Integration

> Want the CLI to generate this for you? → [Automatic Integration](INTEGRATION_AUTO.md)
...
→ [Automatic Integration](INTEGRATION_AUTO.md) — let the CLI generate this for you
